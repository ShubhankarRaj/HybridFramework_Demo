...
//		 Log.info("Click action is performed on My Account link" );
		...
		String HomeLocation = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_HomeLocation);
		...
		String HomePrice = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_HomePrice);
		...
		String DownPayment = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_DownPayment);
		...
		String InterestRate = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_MortgageIntRate);
